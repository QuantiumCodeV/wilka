...
<head>
    ...
    <title><?=$sitename?> - политика конфеденциальности</title><!-- Vendor Bundle CSS -->
    <meta name="description" content="<?=$sitename?> - Настоящий сайт Нвути. Все комиссии берем на себя, бонус при регистрации. Произведем выплаты за 24 часа на любую платежную систему."> <!-- by vk.com/loodklon -->
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-7 text-center">
                <h2 class="page-title">ПОЛИТИКА КОНФЕДЕНЦИАЛЬНОСТИ</h2>
                <p class="large"></p>
            </div>
        </div>
    </div><!-- .container -->
        ...
        <div class="container">
            ...
            <p>
                <br>Создателем скрипта является Владимир Кот - <a href="https://vk.com/id321223555" target="_blank">*тык*</a>
            </p>
          </div>
                        </div>
                    </div><!-- .card -->
