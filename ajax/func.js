      ...
      if(obj.bombs == "true"){
       ...
       $("#finishmines").attr("disabled","disabled");
          ...
          $("#win").html("0.00");
           ...
           if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent)) {
               $(".mine[data-number="+obj.tamines[i]+"]").html('<div  class="click-bomb" onclick="false"><i class="fa fa-bomb text-danger"></i></div>');
           } else $(".mine[data-number="+obj.tamines[i]+"]").html('<div  class="click-bomb" onclick="false"><i class="fa fa-bomb text-danger"></i></div>');
          ...
          // $("#bombHistoryContent").prepend(obj.resultHistoryContentBomb);
               ...
               $('#win').html(obj.win);
               $(".mine[data-number="+obj.pressmine+"]").html('  <div class="click-success" ><i class="fa fa-money text-success"></i></div>');
           $("#startmines").attr("disabled","disabled");
       $("#finishmines").removeAttr("disabled","disabled");
  ...
  $.ajax({
    ...
    success: function(response){
     ...
     if (obj.info = true){
      ...
      $(".mine[data-number="+obj.tamines[i]+"]").html('<img src="../images/gem.svg" style="width:30px; height:30px">');
       if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent)) {
              $(".mine[data-number="+obj.tamines[i]+"]").html('<img src="../images/bomb.png" style="width:60%; height:70%">');
           } else $(".mine[data-number="+obj.tamines[i]+"]").html('<img src="../images/bomb.png" style="width:27px; height:37px">'); //$(".mine[data-number="+obj.tamines[i]+"]").css('font-size', '30px');
      }
      }
}
