...
$photo = $systemimg;
$query1 = mysql_query("INSERT INTO `kot_chat` (`login`,`photo`,`mess`,`vk_id`,`id_users`) VALUES ('$login','$photo','$mess','https://vk.com/loodklon','none')");
 } 
 if($sys) {
       $login = '<span style="color: #0b61bd;font-weight: 600">Система</span>';
...
$query = mysql_query("INSERT INTO `kot_chat` (`login`,`photo`,`mess`,`vk_id`,`id_users`) VALUES ('$login','$photo','$mess','https://vk.com/loodklon','none')");
